...
import { Trophy, Target, Users, Award, Sparkles, TrendingUp, Eye, Clock, Zap, Shield, Heart, Swords, Crosshair } from 'lucide-react';
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {Object.entries(heroes)
                            .filter(([, stats]: any) => stats.matchesPlayed > 0)
